...
class PolicyServiceTest {
    ...
    void 나이가_null이면_빈_리스트를_반환한다() {
        ...
        verify(policyRepository, never()).findMatchingPolicies(anyInt(), anyLong(), anyString());
    ...
    void 나이와_소득이_모두_있으면_매칭_쿼리를_호출한다() {
        ...
        when(policyRepository.findMatchingPolicies(25, 3000000L, null)).thenReturn(List.of());

        policyService.getMatchingPolicies("user-1", null);
